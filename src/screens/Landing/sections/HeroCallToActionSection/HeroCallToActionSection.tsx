...
const statCardKeys = [
  {
    ...
    titleKey: 'hero.stat_assets',
    subtitleKey: 'hero.stat_assets_sub',
  },
  {
    icon: '/svg/container-2.svg',
    titleKey: 'hero.stat_support',
    subtitleKey: 'hero.stat_support_sub',
  },
  {
    icon: '/svg/container-3.svg',
    titleKey: 'hero.stat_profit',
    subtitleKey: 'hero.stat_profit_sub',
  },
  {
    icon: '/svg/container-4.svg',
    titleKey: 'hero.stat_leverage',
    subtitleKey: 'hero.stat_leverage_sub',
  },
]
          ...
          <div className="inline-flex h-[64px] items-center gap-5 rounded-2xl border border-white/[0.05] bg-white/[0.02] py-2 pl-4 pr-6 backdrop-blur-xl">
            ...
            <div className="flex flex-col items-start gap-0.5">
              ...
              <div className="text-[11px] font-normal text-gray-500">
                <span className="font-bold text-white/90">{t("hero.trustpilot")} </span> Rating
              </div>
            </div>
          </div>
        </div>
...
function MobileStatsCarousel() {
  ...
  const totalPages = Math.ceil(statCardKeys.length / 2);
  ...
  const pages = Array.from({ length: totalPages + 1 }).map((_, i) => {
    ...
    return statCardKeys.slice(realIndex * 2, realIndex * 2 + 2);
  });
