...
export const CheckoutDetailSection = (): JSX.Element => {
  return (
    <div className="flex flex-col w-full items-end justify-center gap-[34px]">
      ...
      <div
        className={`${gradientCardClass} inline-flex items-center gap-4 p-[25px] backdrop-blur-[6px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(6px)_brightness(100%)]`}
      >
        <img
          className="w-12 h-12 flex-shrink-0"
          alt="SSL Secure"
